...
export default function DashboardLayout({
    ...
    return (
        <>
            <div className="hidden h-full overflow-x-hidden md:block">
                <Sidebar />

                <DashboardPageContainer>{children}</DashboardPageContainer>
            </div>

            <div className="mx-auto flex h-screen max-w-[500px] flex-col items-center justify-center space-y-4 p-8 md:hidden">
                <Logo />
